...
<?php include("connect.php");
    ...
    //Get restaurant staff new information from the update form and set these as the variables
    ...
    //MySQL statement to update that restaurant staff profile in the database
    ...
    header("Location:DisplayResStaff.php");
?>
